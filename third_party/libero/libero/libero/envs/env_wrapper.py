...
class ControlEnv:
    def __init__(
        ...
        **kwargs,
        ...
        # controller_configs["control_ori"] = False  # ✅ 验证用：只控位置，不控姿态
        # print("[debug] before env create control_ori =", controller_configs.get("control_ori"))
        ...
        # print("passed control_ori =", controller_configs.get("control_ori"))
        # print("robot  control_ori =", self.env.robots[0].controller_config.get("control_ori"))
        # print("same obj?", id(controller_configs) == id(self.env.robots[0].controller_config))
        # print(aaa)
    @property
...
class OnScreenRenderEnv(ControlEnv):
    def __init__(self, **kwargs):
        ...
        # 是否同时保留 offscreen 相机由你决定
        kwargs["has_offscreen_renderer"] = True
        kwargs["render_camera"] = kwargs.get("frontview")
        super().__init__(**kwargs)
