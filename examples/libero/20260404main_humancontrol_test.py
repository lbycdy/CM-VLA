...
print("\n=== Sawyer 控制器缩放信息 ===")
print("controller name:", getattr(ctrl, "name", None))
print("control_delta:", getattr(ctrl, "control_delta", None))
print("output_max:", getattr(ctrl, "output_max", None))
print("output_min:", getattr(ctrl, "output_min", None))
print("input_ref_frame:", getattr(ctrl, "input_ref_frame", None))
# ================================================================
